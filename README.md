...
This was a team project of CSE 183 during Spring 2024. The team includes: Kazuma Takahashi(Index), Turner Lu(Checklist), Kaden Asamoto(Statistics), and Pak Yuen Choi(Location)
...
To run py4web, run this command:

```
./py4web.sh
```

Afterward the web will available at http://localhost:8000/project
